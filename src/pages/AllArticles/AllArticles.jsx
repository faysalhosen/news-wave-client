...
const AllArticles = () => {
    ...
    return (
        <>
            <div>
                <input type="text" placeholder="Search Title"  onBlur={(e) => setSearchValue(e.target.value)} className="w-3/4 md:w-2/4 ml-16 border border-slate-800 py-2 px-4 rounded" />
            </div>
